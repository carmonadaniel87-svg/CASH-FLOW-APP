...
const DEFAULT_ACCOUNT = () => {
  const t = Date.now();
  return {
    id: "acc_"+t+"_"+Math.floor(Math.random()*9999),
    name: "Mis finanzas", emoji:"💛", color:"#FF7043",
    transactions: [],
    wallets: [
      { id:"lw_ef_"+t,     name:"Efectivo",       emoji:"🤑", color:"#39FF14", currency:"COP" },
      { id:"lw_ah_"+(t+1), name:"Cuenta ahorros", emoji:"🏦", color:"#1565C0", currency:"COP" },
      { id:"lw_nq_"+(t+2), name:"NEQUI",          emoji:"💳", color:"#AD1457", currency:"COP" },
    ],
    budgets: [
      { id:"bg_seg_"+t,    name:"SEGURIDAD",  emoji:"🏠", color:"#1565C0", pct:60, goal:null },
      { id:"bg_div_"+t,    name:"DIVERSION",  emoji:"🍕", color:"#1565C0", pct:8,  goal:null },
      { id:"bg_cre_"+t,    name:"CRECIMIENTO",emoji:"🎓", color:"#AD1457", pct:5,  goal:null },
      { id:"bg_vac_"+t,    name:"VACACIONES", emoji:"✈️", color:"#6A1B9A", pct:5,  goal:10000000 },
      { id:"bg_inv_"+t,    name:"INVESTMENT", emoji:"💰", color:"#37474F", pct:10, goal:null },
      { id:"bg_bol_"+t,    name:"BOLSILLO",   emoji:"💼", color:"#39FF14", pct:7,  goal:null },
    ],
  };
};
